...
const Riyadh = () => {
  ...
  DIST, 2740 KING FAHD BRANCH RD, AS SAHAFAH, 6403, RIYADH 13315
  </p>
</div>
          ...
          >
            ...
            <div className="flex-1">
              ...
              <div className="space-y-1">
                <a href="/jasminagentdetails" className="block md:text-sm text-[0.8rem]">Get Evaluation</a>
                <hr  className='hidden md:flex w-60 bg-[rgba(202,3,32,255)] h-[1px] my-2 border-0'/>
                <a 
                  href="/jasminagentdetails" 
