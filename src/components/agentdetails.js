...
<div className="relative bg-gray-100 px-4 md:px-20 py-4 md:py-10">
  ...
  {/* Agent Card Section */}
  <div className="hidden md:flex flex-col md:flex-row md:mt-6 mt-20 shadow-xl rounded-3xl overflow-hidden">
    {/* Left Section */}
    <div className="w-full md:w-2/4 p-6 md:p-10 text-white bg-gray-400 min-h-[80vh]">
      <h1 className="text-2xl md:text-5xl font-bold uppercase mb-6">{agent.name || agent.fullName || '-'}</h1>
      <hr className="w-40 md:w-96 bg-[rgba(202,3,32,255)] h-[2px] my-2 border-0" />
      <div className="space-y-5 text-base md:text-lg font-medium">
  ...
  <span className="break-all">{agent.email || '-'}</span>
    ...
    {/* Right Section */}
    <div className="w-full md:w-2/4 relative flex items-center justify-center bg-red-700">
      ...
      {/* Agent Image */}
      <div className="relative z-10 rounded-full overflow-hidden border-4 border-white shadow-xl bg-gray-100 w-60 h-60 md:w-80 md:h-80 aspect-square">
        <Image
...
<div className="flex flex-col bg-white shadow-lg rounded-2xl p-4 gap-4 md:hidden mt-10">
  {/* Agent Image */}
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
          <div className="bg-white w-full max-w-md rounded-3xl p-6 relative shadow-2xl border border-gray-200">
            ...
            <div className="flex items-center space-x-4 mb-6">
              ...
              />
              <h2 className="text-lg font-bold bg-red-700 text-white px-4 py-1 rounded-full">
            ...
            <form className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full py-3 bg-red-700 hover:bg-red-800 text-white font-bold rounded-full"
              >
                SUBMIT
              </button>
            </form>
